...
const variantClasses: Record<AlertVariant, string> = {
  error:
    "border-[var(--color-danger)] bg-[var(--color-danger-bg)] text-[var(--color-danger)] shadow-brut-danger",
  success:
    "border-[var(--color-success)] bg-[var(--color-success-bg)] text-[var(--color-success)] shadow-brut-success",
...
export function Alert({
  ...
  return (
    <div
      ...
      className={cn("border-2 px-4 py-3", variantClasses[variant], className)}
    >
