...
import { Alert, Spinner } from "@/common/components";import { MapSearch } from '@/common/components/Map/MapSearch';
...
export function MapOverlay({ flightsCount, loading, error, onAirportSelect }: MapOverlayProps) {
  return (
      ...
      <div className="border-2 border-ink bg-surface shadow-brut pointer-events-auto flex items-stretch">
            ...
            {error && (
                <div className="pointer-events-auto">
                    <Alert variant="error">{typeof error === "string" ? error : error.message}</Alert>
