...
import { FormField, Input } from "@/common/components";
...
function formatLabel(airport: Airport | null): string {
  if (!airport) return "";
  return `${airport.name} (${airport.icaoCode}${airport.iataCode ? `/${airport.iataCode}` : ""})`;
}
...
export function AirportSearch({
  ...
  return (
    <FormField label={label} htmlFor={inputId} optional={optional}>
