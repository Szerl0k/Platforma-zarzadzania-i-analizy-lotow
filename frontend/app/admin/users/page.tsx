...
import { Alert, Badge, Button, Card, ConfirmDialog, Input, Spinner } from '@/common/components';
    ...
    return (
        <div className="space-y-6">
                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b-2 border-ink text-left">
                                <th className="px-4 py-3 font-mono text-[11px] uppercase tracking-widest">Email</th>
                                <th className="px-4 py-3 font-mono text-[11px] uppercase tracking-widest">Nick</th>
                                <th className="px-4 py-3 font-mono text-[11px] uppercase tracking-widest">Rola</th>
                                <th className="px-4 py-3 font-mono text-[11px] uppercase tracking-widest">Utworzony</th>
                                    ...
                                    return (
                                        <tr key={u.id} className="border-b border-border-subtle last:border-b-0">
                                            <td className="px-4 py-3 font-sans text-ink">
                                                {u.email}
                                                {isSelf && (
                                                    <Badge variant="info" className="ml-2">TY</Badge>
                                                )}
                                            </td>
                                            <td className="px-4 py-3 font-sans text-ink">{u.nickname ?? '—'}</td>
            ...
            <ConfirmDialog
                ...
                message={
                    <>
                        Czy na pewno chcesz usunąć użytkownika <strong>{deleteTarget?.email}</strong>?
                        Ta operacja jest nieodwracalna i usunie wszystkie jego dane.
                    </>
                }
                confirmLabel="Usuń"
