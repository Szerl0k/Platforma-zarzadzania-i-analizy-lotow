...
export class DropCustomFlightSimulations1778700000000 implements MigrationInterface {
  name = "DropCustomFlightSimulations1778700000000";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE IF EXISTS "custom_flight_simulations"`);
    await queryRunner.query(`DROP TABLE IF EXISTS "simulation_statuses"`);
  }
